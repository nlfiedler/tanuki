...
export default ({
  ...
  /**
   * Walk every asset and, for image assets that lack persisted metadata,
   * fetch the raw EXIF tags from the blob store and persist parsed metadata.
   *
