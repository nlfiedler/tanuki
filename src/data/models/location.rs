            ...
            impl<'de> _serde::de::Visitor<'de> for __FieldVisitor {
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        "city" => _serde::__private::Ok(__Field::__field1),
                    ...
                    __E: _serde::de::Error,
                {
                    match __value {
                        ...
                        b"city" => _serde::__private::Ok(__Field::__field1),
            ...
            impl<'de> _serde::de::Visitor<'de> for __Visitor<'de> {
                    ...
                    __A: _serde::de::MapAccess<'de>,
                {
                        ...
                        match __key {
                            ...
                            __Field::__field2 => {
                                if _serde::__private::Option::is_some(&__field2) {
                                    return _serde::__private::Err(
                                        <__A::Error as _serde::de::Error>::duplicate_field("region"),
                                    );
                                }
                    ...
                    let __field2 = match __field2 {
                        ...
                        _serde::__private::None => {
                            _serde::__private::de::missing_field("region")?
                        }
                    };
                    _serde::__private::Ok(Location {
                        label: __field0,
