  ...
  views: {
    ...
    by_filename: {
      map: function (doc) {
        ...
        let location = doc.location || null
        emit(doc.filename, [date, doc.filename, location, doc.mimetype])
      }.toString()
    },
    by_location: {
      map: function (doc) {
        if (doc.location) {
          ...
          emit(doc.location, [date, doc.filename, doc.location, doc.mimetype])
        }
      }.toString()
    },
    by_mimetype: {
      map: function (doc) {
        ...
        let location = doc.location || null
        emit(doc.mimetype, [date, doc.filename, location, doc.mimetype])
      }.toString()
    },
    by_tag: {
      map: function (doc) {
        if (doc.tags && Array.isArray(doc.tags)) {
          ...
          doc.tags.forEach(function (tag) {
            ...
            emit(tag, [date, doc.filename, location, doc.mimetype])
          })
        }
      }.toString()
    },
