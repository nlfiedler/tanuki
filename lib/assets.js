...
async function retrieveThumbnail (mimetype, checksum) {
  ...
  const thumbnail = await generateThumbnail(mimetype, filepath)
  if (thumbnail) {
...
// Generate a thumbnail for the asset. May return null.
async function generateThumbnail (mimetype, filepath) {
