...
// Parse the user date (e.g. '2003-08-30 12:45') into an array of numbers.
function parseUserDate (userDate) {
  let [date, time] = userDate.split(' ')
  let [year, mon, day] = date.split('-').map(x => parseInt(x))
