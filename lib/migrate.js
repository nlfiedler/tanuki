...
function dataVersion7 (doc) {
  //
  // Skip any document that already has the checksum field (again), as this
...
function postVersion7 (doc) {
  ...
  //
  const part1 = doc.sha256.slice(0, 2)
  const part2 = doc.sha256.slice(2, 4)
  const part3 = doc.sha256.slice(4)
