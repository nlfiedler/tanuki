...
const Query = {
  ...
  async search (obj, args, context, info) {
    const tags = args.params.tags || null
    const locations = args.params.locations || null
    const after = args.params.after || null
    const before = args.params.before || null
    let rows = await backend.query(tags, locations, after, before)
