...
*** TODO should limit the number of recents displayed to 100 or something
*** TODO make the cursor a pointer over thumbnail =figure= elements
*** TODO add some padding below the pagination controls
*** TODO add some padding below the asset edit form
*** TODO offer a button to download the raw asset on the show asset page
**** apparently cannot download a video by clicking on it
