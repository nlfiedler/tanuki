...
**** DONE use case: query recent imports
**** DONE use case: bulk update of assets
**** DONE develop page for processing recent imports
**** DONE use case: update asset details
**** DONE develop page for editing assets details
**** DONE dates should be displayed using local time
***** asset browser list
***** asset details page
***** asset editor page
...
**** TODO add link/button to download raw asset
**** TODO try to get drag and drop to work for uploading files
***** c.f. https://gist.github.com/PlugFox/ffe83a91ce50f9c78a5b1d6674e36d1b
**** TODO show broken thumbnail placeholder for missing thumbnails
***** browse page
***** recents page
...
**** home page needs to refresh tags/locations/years when navigating back
***** can use =NavigatorObserver= with =MaterialApp= to watch for changes
***** consider replacing routes vs pushing and navigate using another means
***** after upload (new dates)
***** after bulk update
***** after asset edit
...
**** quick import
***** look for a way to allow zoom on the recent imports thumbnails
