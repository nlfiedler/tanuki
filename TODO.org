...
**** only effects production web builds, probably a dart2js issue
**** look for tools to debug production web code
**** consider alternatives to filter input chips
*** TODO Try building for macOS
