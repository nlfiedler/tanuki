* Tanuki
** TODO run the benchmarks again with the Node.js version of the app
*** use =hey= and the test set of images
...
**** TensorFlow has dart and rust bindings
