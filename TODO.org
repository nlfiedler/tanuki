...
** [#A] convert the few HEIC files into JPG
*** manually convert the files, then fix the database records (ID and mimetype)
** [#B] Location improvements
...
** [#C] Enable rotating and flipping images from the asset edit page
