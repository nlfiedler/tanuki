...
*** Phase 2 goals [2/5]
- [X] basic details/edit page
- [X] ~import~ usecase and button on uploads page
- [ ] search query language
- [ ] search page
- [ ] search caching?
*** Phase 3 goals [0/5]
- [ ] asset browsing with left/right buttons
- [ ] ~Replace~ button on details page
- [ ] read creation time from mpeg files
- [ ] read date from RIFF/AVI files
- [ ] look for HEIC support
*** Overall action Items
**** TODO store various selections in local storage [12/19]
- [X] (recent) page size
