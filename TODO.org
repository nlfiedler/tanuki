...
** TODO Fix chips input
*** DONE set up flutter sdk, pub get, test
*** TODO learn to use debugger to track focus
*** TODO bug #3: FocusNode was used after being disposed
**** =flutter_input_chips= changelog says an issue just like this one is fixed in 1.9.5
**** c.f. https://github.com/flutter-form-builder-ecosystem/form_builder_extra_fields/issues/3
*** TODO bug #66: web version loses focus after 1 character
**** happens in ios simulator
*** TODO bug #92: add more form elements to try to reproduce
*** TODO bug #703: add radio buttons to try to reproduce
*** TODO fix broken network image links in example
** TODO Try to update Flutter SDK
*** need =flutter_chips_input= verison 2.0 for flutter 3.0 support
*** need to fix chips input to work with latest flutter
*** then try updating as many dependencies as possible
*** may encounter problems with other pinned dependencies
