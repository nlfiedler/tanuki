...
- [TODO] Upload page should show the file name (does nothing when a file is selected)
- [TODO] Upload page no longer receives dropped files
- [TODO] Upload page button should be disabled until form is valid
  - btw, the error page that is displayed should be using bulma styles
