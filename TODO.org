...
** TODO bug: 1913 photos not appear at the end of home page results
*** only happens on RocksDB, SQLite is fine
*** test locally
*** could be the =query_newborn()= is handling the date incorrectly
