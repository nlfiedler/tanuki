...
**** are indexes really necessary? SQLite seems fine without them
*** TODO find out how to create app-defined functions (for =best_date()=)
**** scalar UDF support was added in 1.2.0 Feb 10, 2025
**** c.f. https://github.com/duckdb/duckdb-rs/pull/429
