...
**** filename: =adbd3131a14034540614ebe02efc4060f792501e94771b54ede16657bd38= (now =IMG_0912.JPG=)
**** original date probably missing
*** DONE provide tools to fix data issues
**** DONE add additional optional fields to =AssetInput= for manual fixes
***** use it to fix the filename that is part of a digest
****** should be =IMG_0912.JPG= or =IMG_0914.JPG= (neither occur in the database)
**** file sizes will be wrong because of the auto-orient performed previously
**** DONE write a graphql query to run a data integrity check
***** look for problems and return list of identifiers that have issues
**** DONE write a graphql mutation to diagnose and repair issues
