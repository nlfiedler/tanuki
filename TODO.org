* Action Items
** consider replacing =flutter_chips_input=, it has many problems
*** https://pub.dev/packages/flutter_chip_tags
*** https://pub.dev/packages/simple_chips_input
*** https://pub.dev/packages/flutter_input_chips
...
**** chip input field for applying existing tags
***** be sure to allow more than 10 chips for tags, sometimes need many tags
**** text field to enter new tags (comma-separated)
**** text field for entering a location
