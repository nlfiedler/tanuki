...
*** 21,5xx assets, disk usage immediately after load, before compaction
| Metric     | RocksDB    | SQLite     | DuckDB     |
|------------+------------+------------+------------|
| load time  | 4 sec      | 6 min      | 6m 24s     |
| disk uage  | 39,298,784 | 13,450,984 | 12,736,628 |
| asset size | 1827       | 625        | 590        |
*** with 22,320 assets, compacted DuckDB uses 11,284,480 bytes (505/asset)
...
** Navbar
*** light/dark mode is broken after Leptos 0.7 upgrade
...
**** c.f. https://github.com/leptos-rs/leptos/discussions/3431
**** maybe need to use the cookie support in =use_color_mode()=
#+begin_src rust
