* Action Items
** TODO diagnose is hanging?
*** stops at asset MjAxNC8xMi8yMS8wMDE1LzAxY2UxcWQ3cWVwMndiMWY4OWduNW1kNHpqLmF2aS5tb3Y=
*** use =/zeniba/shared/tanuki/assets/blobstore/2014/12/21/0015/01ce1qd7qep2wb1f89gn5md4zj.avi.mov= in test suite
** ~lookup~ query should return file path (decoded id)
...
*** using version 0.13 which does not have the problem, but 0.14 does
