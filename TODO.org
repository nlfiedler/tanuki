...
***** DONE query by tags: use =query_all_keys()=
***** DONE query by date range: use =query_range()=
***** DONE query by location
***** DONE query by filename
***** DONE query by media type
***** DONE filter by date range
***** DONE filter by location
***** DONE filter by filename
***** DONE filter by media type
***** TODO test with mixed-case tags in assets and search parameters
***** TODO test with mixed-case locations in assets and search parameters
***** TODO test with mixed-case filenames in assets and search parameters
***** TODO test with mixed-case mimetype in assets and search parameters
***** TODO test with mixed-case checksum in assets and search parameters
***** TODO order by date range (up/down)
***** should be able to search and filter all combinations (as before)
