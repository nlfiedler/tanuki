...
*** DONE grid of 640x640 images with caption info (date, location/filename) (a la PhotoPrism)
*** DONE can videos show a thumbnail instead of placeholder?
*** DONE search page should have same gallery features as home page
*** TODO deploy and run the backfill operations on chihiro [/]
- [ ] run back-fill: fix original dates
- [ ] run back-fill: backfill image metadata
- [ ] run back-fill: backfill video metadata
