...
*** perform dump, deploy, load [/]
- [ ] dump current database
- [ ] stop container
- [ ] rename database
- [ ] build and deploy
- [ ] load from file
- [ ] test search (anniversary + sausalito)
- [ ] test recents (301)
*** run ~geocode~ to fix all of the asset locations
...
*** boolean argument actually perform the delete
*** if argument is false, only reports what would be deleted
