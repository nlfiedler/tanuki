* Tanuki
** General Items
*** DONE Rewrite Elm interface using ReasonReact
...
**** DONE Load/Save search form inputs using reductive
**** DONE Delete =elm-src=, =elm-stuff=, and =elm-package.json=
**** DONE Look for any lingering "elm" references in the code
**** DONE Compare the generated =bsconfig.json= to the one we have
...
**** DONE Before and After (Elm vs Reason)
