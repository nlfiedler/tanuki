...
***** DONE test with mixed-case tags in assets and search parameters
***** DONE test with mixed-case locations in assets and search parameters
***** DONE test with mixed-case filenames in assets and search parameters
***** DONE test with mixed-case mimetype in assets and search parameters
***** DONE test with mixed-case checksum in assets and search parameters
