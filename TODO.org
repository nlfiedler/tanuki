* Tanuki
** Data Corruption
*** click ~reno~ location, one of the images is broken
*** click ~mt rose~ location, one of the images is broken
*** asset 1: =MjAxOC8wNS8yMS8xNzE1LzAxY2UxdnZiem0yZm10a3N0MmYzMDRxODRt=
**** filepath: =2018/05/21/1715/01ce1vvbzm2fmtkst2f304q84m=
**** checksum: =sha256-f0bbbaa2dcc41e414712895cb1507b8c95002df9771933925de8b1645c1f15a9=
**** filename: =nathan_antonia_at_mt_rose=
**** original date probably missing
*** asset 2: =MjAxOC8wNS8yMS8xNzE1LzAxY2Uxdms4NjJtejU2ajcybjBxd21nMTll=
**** filepath: =2018/05/21/1715/01ce1vk862mz56j72n0qwmg19e=
**** checksum: =sha256-03daadbd3131a14034540614ebe02efc4060f792501e94771b54ede16657bd38=
**** filename: =adbd3131a14034540614ebe02efc4060f792501e94771b54ede16657bd38=
**** original date probably missing
*** TODO provide tools to fix data issues
**** TODO add additional optional fields to =AssetInput= for manual fixes
***** use it to fix the filename that is part of a digest
****** should be =IMG_0912.JPG= or =IMG_0914.JPG= (neither occur in the database)
**** TODO write a graph query to run a data integrity check
***** looks for problems and returns list of identifiers that have issues
***** asset is missing
***** =original_date= not set at all, or set to wrong value
***** identifier is missing an extension appropriate for the media type
***** filename is missing an extension appropriate for the media type
**** TODO write a graph mutation to fix the identified assets
***** take list of identifiers for assets with known issues
***** attempt to fix whatever issues are detected
****** append missing extension to filename, identifier, asset file
****** set the missing original date
***** if asset identifier has changed, insert-new/delete-old
***** if asset identifier did not change, update record
***** return list of successfully fixed assets
** Quick UI improvements
*** TODO make the cursor a pointer over thumbnail =figure= elements
*** TODO add some padding below the pagination controls
...
*** Machine learning to rank photos on various qualities
