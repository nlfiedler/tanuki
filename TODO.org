...
- [TODO] Evaluate how to move navbar into Elm
  - each area reached via the navbar has a different Elm state
  - search form values reset upon entry
  - error page would do away with navbar entirely, add "back" and "home" buttons
