* Tanuki
** Run books
*** Write a shared google doc that explains how to set up tanuki
**** install docker (desktop)
**** set up github key for repo
**** clone tanuki repo
**** run docker commands to build
**** push the image
**** clone provisioning repo
**** install python, ansible (using homebrew)
**** ansible-playbook to install tanuki
** Backend Rewrite
...
*** TODO recents image should link to show asset page
...
**** default the sort order to descending date in graphql module
