...
** TODO change gallery display to favor location over filename
** TODO asset details page should show all location fields, even if city or region is not set
** TODO fix GraphQL field names ~mediaType~ to be ~mimetype~ consistently
** TODO perform database migration again
