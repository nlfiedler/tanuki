...
** [#A] Migrate the production database
*** do _not_ build and deploy the app with schema changes yet
*** steps [1/8]
- [X] dump to a file
- [ ] stop the container
- [ ] rename the database directory
- [ ] build and deploy new version of app
- [ ] confirm it is empty
- [ ] load the dump file
- [ ] confirm search is working (~anniversary~ and ~sausalito~)
- [ ] confirm recents are still recent (~300)
