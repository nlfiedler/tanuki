...
***** record database
***** blob store
*** TODO implement and test =query_by_checksum()= in data source
*** TODO implement use cases
**** TODO get asset by checksum
**** TODO count all assets
...
***** translate the database =query()= function in =backend.js=
