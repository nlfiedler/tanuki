...
**** TODO asset details page [8/10]
- [X] clicking search result navigates to details page
- [X] show preview of asset
- [X] ~Download~ button
- [X] ~GetAsset~ usecase
- [X] =asset()= GraphQL resolver
- [X] fetch asset via GraphQL
- [X] show form with details
- [X] ~Save~ button
- [ ] ~Replace~ button
- [ ] left-right buttons
...
**** DONE about the =.env= file and how Bun reads that by default
...
**** DONE write new ADR(s)
**** DONE update =doc/DEPLOY.md=
