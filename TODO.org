* Tanuki
** [#A] Quick improvements
*** enhance attribute selector with a drop-down selector
**** maybe copy =FormBuilderChipsInput= code and modify appropriately
**** maybe use =Stack= and =Align= and combine with a drop-down
