...
- [TODO] add a search form
  - use a multi-field form with a search icon button
    - input field for each field in SearchParams
  - maybe replace the selectors with the form, showing the thumbnails below
    - maybe based on the route?
