...
*** DONE Translate the server code (=www=, =app.js=) to TypeScript
*** DONE Translate the routes to TypeScript
*** DONE Fix the =Dockerfile= file references to =app.js= and =bin=
