...
**** =Orientation: 1=
**** =Date of original image: 2003:09:03 17:24:35=
...
** Data Format Support
*** TODO Extend the EXIF crate to recognize additional fields
**** EXIF: https://crates.io/crates/rexif (MIT)
**** unrecognized field: ~Pixel X Dimension~
**** unrecognized field: ~Pixel Y Dimension~
**** unrecognized field: ~Components Configuration~
**** misspelled field? ~Meteting mode~
...
**** the =rexif= crate can recognize many GPS related fields
