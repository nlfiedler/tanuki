  ...
  test('should import several new assets', async function () {
    ...
    const mockRecordRepository = recordRepositoryMock({
      putAsset: mock((asset: Asset) => {
        ...
        if (
          asset.checksum ===
          'sha256-c2794b60c938b42635ba254539f4e8fa3f56176511be55153cb5298d029c91e5'
        ) {
        ...
        if (
          asset.checksum ===
          'sha256-269b5cc1eeb21b8bba2881e96b2e6bc8109c4edf150d3fda69d8f87bf34acd81'
        ) {
        ...
        if (
          asset.checksum ===
          'sha256-c10f31a5f7a77eae84f9595bef2494226e040c64713454700e04b1f9eb829163'
        ) {
    ...
    expect(mockBlobRepository.storeBlob).toHaveBeenCalledTimes(14);
    expect(mockRecordRepository.putAsset).toHaveBeenCalledTimes(14);
    mock.clearAllMocks();
  });
});
